...
########
# EXECUTION: provision_minio.py minio.my-project-domain.com True
# args:
#   - minio.my-project-domain.com : minio url
#   - True : if TLS should be used (`False` if not)
########
